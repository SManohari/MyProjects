...
export function renderOrderSummary(){
  ...
  cart.forEach((cartItem)=>{
    ...
    //code to display Delivery date for class = "delivery-date"
        ...
        <div class="cart-item-details-grid">
          ...
          <div class="cart-item-details">
            ...
            <div class="product-quantity">
              ...
              <span class="link-primary js-delete-quantity" 
                    data-product-id = "${matchingProduct.id}">
                Delete
              </span>
            </div>
 ...
 //code for delete link
  document.querySelectorAll('.js-delete-quantity')
    .forEach((deleteLink) => {
      ...
      //To update checkout in top Header Icons of Checkout after deleting 
      updateCartQuantity();
      });
    renderPaymentSummary();
    });

   //To update checkout in top Header Icons of  Checkout
  ...
  function deliveryOptionHTML(matchingProduct,cartItem){
    ...
    let html = '';
       ...
       deliveryOptions.forEach((deliveryOption)=>{
        ...
        //code to calculate Price Cents
        const priceString = deliveryOption.priceCents === 0 ? 'FREE' : 
        `$${formatCurrency(deliveryOption.priceCents)} - `;

        //code for input elements checked (or) not
